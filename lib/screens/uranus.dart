...
class _UranusPageState extends State<UranusPage> {
  ...
  List<String> price = ['4000', '4500', '3000'];
  List<String> time = ['95', '83', '109'];
  List<String> distance = ['9', '9', '8.8'];
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Uranus', style: TextStyle(color: Color(0xFF5AE0FC)),),
        centerTitle: true,
        leading: IconButton(
...
//        padding: EdgeInsets.only(),
          child: Container(
            decoration: BoxDecoration(
                ...
                image: DecorationImage(image: AssetImage('images/uranus.jpeg'), fit: BoxFit.cover)
            ),
            child: Column(
              children: <Widget>[
                SizedBox(
